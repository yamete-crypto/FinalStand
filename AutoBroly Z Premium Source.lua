...
if game.PlaceId == 3565304751 then
	planeta.Text = "[Premium] Joining Broly Raid..."
...
elseif game.PlaceId == 2050207304 then
	planeta.Text = "[Premium] Fighting Broly..."
	getgenv().Moves = {
		Move1,
		Move2,
		Move3,
	...
	planeta.Text = "[Premium] Teleporting to Queue..."
